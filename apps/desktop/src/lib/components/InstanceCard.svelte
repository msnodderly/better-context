...
<div class="relative" style="--delay: 40ms">
	...
	{#if isExpanded}
		...
		></button>
		<div
			class="bc-card absolute top-full right-0 left-0 z-50 mt-1 flex max-h-[70vh] flex-col gap-6 overflow-y-auto p-6 shadow-xl"
		>
			...
			{:else}
				...
				<div class="grid gap-4 lg:grid-cols-[1.35fr_0.65fr]">
					<div class="bc-card bg-[hsl(var(--bc-surface-2))] p-4">
						<div class="flex items-start justify-between gap-4">
							<div>
								<p class="bc-muted text-xs tracking-[0.2em] uppercase">Status</p>
					...
					<div class="bc-card bg-[hsl(var(--bc-surface-2))] p-4">
						<p class="bc-muted text-xs tracking-[0.2em] uppercase">Controls</p>
				...
				<div class="bc-card bg-[hsl(var(--bc-surface-2))] p-4">
					<p class="bc-muted text-xs tracking-[0.2em] uppercase">Versions</p>

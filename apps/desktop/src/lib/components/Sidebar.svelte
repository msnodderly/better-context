...
<div class="bc-sidebar-inner">
	...
	<div class="bc-sidebar-section">
		<button
			type="button"
			class="flex w-full items-center justify-between px-1 py-1 text-[10px] font-semibold tracking-wider uppercase opacity-60 hover:opacity-100"
		...
		>
			<div class="flex min-w-0 items-center gap-2">
				...
				{#if !showProjectsSection && projectStore.selectedProject}
					<span
						class="max-w-[120px] truncate text-[10px] font-normal tracking-normal normal-case opacity-80"
					>
	...
	<div class="bc-sidebar-section">
		<div class="px-1 py-1 text-[10px] font-semibold tracking-wider uppercase opacity-60">
			Workspace
		</div>
		<div class="mt-1 flex flex-col gap-0.5">
			<a
	...
	<div class="bc-sidebar-footer">
		{#if auth.isSignedIn && auth.user}
			<div class="sidebar-user-menu relative">
				...
				{#if showUserMenu}
					<div
						class="bc-card bc-sidebar-dropdown absolute right-0 bottom-full left-0 mb-2 p-2 text-xs"
					>
						<a
							href="/app/support"

			...
			<div class="bc-card p-4">
				<div class="flex flex-col gap-4">
					<div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
						<div class="min-w-0">
							<label for="mcp-search" class="bc-muted text-xs font-medium tracking-wide uppercase">
								Search
							</label>
							<div class="relative mt-2">
								<Search size={14} class="bc-muted absolute top-1/2 left-3 -translate-y-1/2" />
								<input
									id="mcp-search"
									type="text"
						...
						<div class="min-w-0">
							<label
								for="mcp-resource"
								class="bc-muted text-xs font-medium tracking-wide uppercase"
							>
								Resource
							</label>
							<Dropdown
						...
						<div class="min-w-0">
							<label for="mcp-sort" class="bc-muted text-xs font-medium tracking-wide uppercase">
								Sort
							</label>
							<button
								id="mcp-sort"
